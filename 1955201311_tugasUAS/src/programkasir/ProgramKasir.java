...
public class ProgramKasir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TOKO QITAB BERSATU ");

        RBNG.setText("kitab taqrib");
    ...
    private void RBNGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBNGActionPerformed
        ...
        int kitabtaqrib=15000;
        if(RBNG.isSelected()){
            TxtRBNG.setText("" +RBNG.getText());
            TxtRBNG.setText("" +kitabtaqrib);
        }else{
            TxtRBNG.setText("");
        }
    ...
    private void RBMGActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBMGActionPerformed
        // TODO add your handling code here:
         int kitabfaroit=15000;
        if(RBMG.isSelected()){
            TxtRBMG.setText("" +RBMG.getText());
            TxtRBMG.setText("" +kitabfaroit);
        }else{
            TxtRBMG.setText("");
        }
    ...
    private void RBSAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBSAActionPerformed
        // TODO add your handling code here:
         int kitabhadist=15000;
        if(RBSA.isSelected()){
            TxtRBSA.setText("" +RBSA.getText());
            TxtRBSA.setText("" +kitabhadist);
        }else{
            TxtRBSA.setText("");
        }
    ...
    private void RBSKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBSKActionPerformed
        // TODO add your handling code here:
         int kitabsorof=25000;
        if(RBSK.isSelected()){
            TxtRBSK.setText("" +RBSK.getText());
            TxtRBSK.setText("" +kitabsorof);
        }else{
            TxtRBSK.setText("");
        }
    ...
    private void RBNSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RBNSActionPerformed
        // TODO add your handling code here:
         int kitabjurumiyah=5000;
        if(RBNS.isSelected()){
            TxtRBNS.setText("" +RBNS.getText());
            TxtRBNS.setText("" +kitabjurumiyah);
        }else{
            TxtRBNS.setText("");
        }
